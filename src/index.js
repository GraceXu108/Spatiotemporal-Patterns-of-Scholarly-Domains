...
// var selectedProvinces = ["Beijing", "Shanghai", "Jiangsu", "Guangdong"];
// var selectedProvinces = ['Beijing', 'Tianjin', 'Hebei', 'Shanxi', 'Inner Mongolia', 'Liaoning', 'Jilin', 'Heilongjiang', 'Shanghai', 'Jiangsu', 'Zhejiang', 'Anhui', 'Fujian', 'Jiangxi', 'Shandong', 'Henan', 'Hubei', 'Hunan', 'Guangdong', 'Guangxi', 'Hainan', 'Chongqing', 'Sichuan', 'Guizhou', 'Yunnan', 'Tibet', 'Shaanxi', 'Gansu', 'Qinghai', 'Ningxia', 'Xinjiang', 'Taiwan', 'Hongkong', 'Macao'];
var selectedYears = [2017, 2018, 2019, 2020];
// var selectedYears = [2017];
                ...
                if (provinces[i] != geo_data.features[j].properties.name) continue;
                    ...
                    for (var k = 0; k < arr_paper.length; k++) {
                        if (year != arr_paper[k].year) continue;
                            ...
                            // console.log(arr_paper[k].json, year, geo_data.features[j].properties.centroid, provinces[i]);
...
function createSelector(GeoData) {
    ...
    // $('#selectProvinceMap').multipleSelect('setSelects', [11, 12, 13, 14, 15, 21, 22, 23, 31, 32, 33, 34, 35, 36, 37, 41, 42, 43, 44, 45, 46, 50, 51, 52, 53, 54, 61, 62, 63, 64, 65, 71, 81, 82]);
